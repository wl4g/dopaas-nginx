...
static ngx_http_module_t  ngx_http_devops_module_ctx = {
...
ngx_module_t  ngx_http_devops_module = {
    NGX_MODULE_V1,
    &ngx_http_devops_module_ctx, /* module context */
...
ngx_http_footer_header_filter(ngx_http_request_t *r)
{
    ...
    lcf = ngx_http_get_module_loc_conf(r, ngx_http_devops_module);
    ...
    ngx_http_set_ctx(r, ctx, ngx_http_devops_module);
...
ngx_http_footer_body_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    ctx = ngx_http_get_module_ctx(r, ngx_http_devops_module);
    if (ctx == NULL) {
